...
XYZ myPos;                         // Tracker's own measurement
XYZ baseCorrectedXYZ[NUM_BASES][NUM_TRACKERS];  // Latest corrected from bases
...
void loop() {
  ...
  // Always listen for base-corrected multicast
  receiveBasePackets();
...
void measureDistance() {
  ...
  // Apply two-way correction from bases if available
  int count=0;
